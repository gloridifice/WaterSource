...
public class ConfigRegistry {
    ...
    static {
        ...
        OPEN_WATER_SATURATION_LEVEL = COMMON_BUILDER.comment("It decides if player can see water saturation level.","Default:false").define("displayWaterSaturationLevel",false);
        OPEN_FOOD_WATER_LEVEL = COMMON_BUILDER.comment("It decides if player can see foods/drinks' water level.","Default:true").define("displayFoodsWaterLevel",true);
