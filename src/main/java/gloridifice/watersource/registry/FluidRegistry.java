...
public final class FluidRegistry {
    ...
    public static RegistryObject<FlowingFluid> COCONUT_JUICE = FLUIDS.register("coconut_juice", () -> {
        return new ForgeFlowingFluid.Source(FluidRegistry.COCONUT_MILK_PROPERTIES);
    });
    public static RegistryObject<FlowingFluid> COCONUT_JUICE_FLOWING = FLUIDS.register("coconut_juice_flowing", () -> {
    ...
    public static ForgeFlowingFluid.Properties SOUL_WATER_PROPERTIES = new ForgeFlowingFluid.Properties(SOUL_WATER, SOUL_WATER_FLOWING, FluidAttributes.builder(STILL_FLUID_TEXTURE, FLOWING_FLUID_TEXTURE)
            .color(0xCC725F45).viscosity(1000))
            .bucket(ItemRegistry.itemSoulWaterBucket).block(BlockRegistry.BLOCK_SOUL_WATER_FLUID)
            .slopeFindDistance(3).explosionResistance(100F);
    public static ForgeFlowingFluid.Properties COCONUT_MILK_PROPERTIES = new ForgeFlowingFluid.Properties(COCONUT_JUICE, COCONUT_JUICE_FLOWING, FluidAttributes.builder(STILL_FLUID_TEXTURE, FLOWING_FLUID_TEXTURE)
