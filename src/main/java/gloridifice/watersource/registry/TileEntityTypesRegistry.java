...
import gloridifice.watersource.common.tile.FluidTankTile;
...
public final class TileEntityTypesRegistry extends RegistryModule{
    ...
    public static final TileEntityType<FluidTankTile> FLUID_TANK = (TileEntityType<FluidTankTile>) TileEntityType.Builder.create(() -> new FluidTankTile(5000), BlockRegistry.BLOCK_STONE_RAIN_COLLECTOR).build(null).setRegistryName("stone_rain_collector");
