...
public class ConfiguredFeatureRegistry {
    public static final ConfiguredFeature<TreeConfiguration, ?> COCONUT_TREE =
            register("coconut_tree", FeatureRegistry.COCONUT_TREE
                    .configured((new net.minecraft.world.level.levelgen.feature.configurations.TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(BlockRegistry.BLOCK_COCONUT_TREE_LOG.defaultBlockState())
                            , new FancyTrunkPlacer(3, 11, 0)
                            , new SimpleStateProvider(BlockRegistry.BLOCK_COCONUT_TREE_LEAF.defaultBlockState()), new SimpleStateProvider(BlockRegistry.BLOCK_COCONUT_SAPLING.defaultBlockState())
