...
public class ItemRegistry extends RegistryModule{
    public final static Item itemPrimitiveStrainer = new StrainerItem("primitive_strainer",25);
    public final static Item itemPaperStrainer = new StrainerItem("paper_strainer",16);
    public final static Item itemSoulStrainer = new StrainerItem("soul_strainer",25);
    public final static Item itemPaperSoulStrainer = new StrainerItem("paper_soul_strainer",16);
