...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(ModBlockTags.PURIFICATION_STRAINERS).add(BlockRegistry.PRIMITIVE_STRAINER.get(), BlockRegistry.PAPER_STRAINER.get());
        this.tag(ModBlockTags.SOUL_STRAINERS).add(BlockRegistry.SOUL_STRAINER.get(), BlockRegistry.PAPER_SOUL_STRAINER.get());
